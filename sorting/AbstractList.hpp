...
class AbstractList
{
  public:
     ...
     * (remove it from the first position, insert it at the second)
     * uses 0-based indexing
     * @param from index of the item to be moved
     * @param to index to move the item to
     * @throws std::out_of_range if either from or to is out of range
     * @post item has been moved, and relative order of other items is preserved.
     * @post if from == to, item stays in place */
